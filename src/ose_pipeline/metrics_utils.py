...
def interp_on_alongtrack(gridded_dataset,
    ...
    if isinstance(gridded_dataset, xr.Dataset):
...
def eval_ose(path_alongtrack,
    ...
    Input:
        ...
        rec_ds (xarray Dataset) -- reconstruction dataset netcdf on which metrics are computed.
